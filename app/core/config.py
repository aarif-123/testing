...
class Settings:
    ...
    NEO4J_ENABLED: bool = bool(os.getenv("NEO4J_ENABLED", "False") == "True")
    ...
    STORE_B_ENABLED: bool = bool(
        os.getenv("ARXIV_SUPABASE_URL", "") and os.getenv("ARXIV_SUPABASE_KEY", "")
    )
    ...
    AUTO_INGEST_ARXIV: bool = bool(
        os.getenv("AUTO_INGEST_ARXIV", "True") == "True"
    )
    ...
    def validate(self):
        ...
        if self.NEO4J_ENABLED:
            required.extend(["NEO4J_URI", "NEO4J_USER", "NEO4J_PASSWORD"])
